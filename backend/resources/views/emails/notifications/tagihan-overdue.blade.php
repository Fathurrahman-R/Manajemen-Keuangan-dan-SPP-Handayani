...
<head>
    ...
    <title>Tagihan Terlambat</title>
</head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    <div style="background-color: #c0392b; color: #ffffff; padding: 20px; text-align: center; border-radius: 5px 5px 0 0;">
        <h1 style="margin: 0; font-size: 24px;">Handayani</h1>
        <p style="margin: 5px 0 0;">Pemberitahuan Tagihan Terlambat</p>
    </div>
    ...
    <div style="background-color: #ffffff; padding: 20px; border: 1px solid #e0e0e0; border-top: none;">
        ...
        <p>Kami informasikan bahwa tagihan berikut telah melewati tanggal jatuh tempo selama <strong>{{ $daysOverdue }} hari</strong>:</p>
        ...
        <table style="width: 100%; border-collapse: collapse; margin: 15px 0;">
            ...
            <tr>
                <td style="padding: 8px; border: 1px solid #ddd; background-color: #f5f5f5; font-weight: bold;">Hari Terlambat</td>
                <td style="padding: 8px; border: 1px solid #ddd; color: #c0392b; font-weight: bold;">{{ $daysOverdue }} hari</td>
            </tr>
        </table>

        <p>Mohon segera lakukan pembayaran untuk menghindari konsekuensi lebih lanjut. Terima kasih.</p>
