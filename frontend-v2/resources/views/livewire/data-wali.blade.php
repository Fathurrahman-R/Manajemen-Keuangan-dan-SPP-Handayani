        ...
        <table class="w-full">
            <thead class="bg-gray-300">
                <tr>
                    ...
                    <th class="py-2">Pendidikan Terakhir</th>
            ...
            <tbody>
                ...
                <tr class="py-4 border-l border-r border-b border-gray-200">
                    ...
                    <td class="text-center py-4">{{ $item['jenis_kelamin'] }}</td>
                    <td class="text-center py-4">{{ $item['agama'] }}</td>
                    <td class="text-center py-4">{{ $item['pendidikan_terakhir'] }}</td>
                    <td class="text-center py-4">{{ $item['pekerjaan'] }}</td>
                    <td>
                        <div class="flex flex-row gap-x-2 justify-center">
                            <x-icon name="eye" class="w-6 h-6 cursor-pointer" />
                            <x-icon name="pencil" class="w-6 h-6 text-[#E9D502] cursor-pointer" />
                            <x-icon name="trash" class="w-6 h-6 text-[#FF0D0D] cursor-pointer" />
                        </div>
                    </td>
                </tr>
                @endforeach
