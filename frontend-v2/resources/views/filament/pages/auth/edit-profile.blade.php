            ...
            <div class="space-y-3">
                ...
                @if($currentEmail)
                    <div class="flex items-center justify-between gap-2 text-sm text-gray-600 dark:text-gray-400">
                        ...
                        @if(!$emailVerified)
                            <button type="button" wire:click="sendOtp" wire:loading.attr="disabled" class="text-xs font-medium text-primary-600 hover:text-primary-500 dark:text-primary-400 dark:hover:text-primary-300">
                                <span wire:loading.remove wire:target="sendOtp">Verifikasi</span>
            ...
            <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50" wire:click.self="cancelOtp">
                <div class="w-full max-w-md rounded-xl bg-white p-6 shadow-xl dark:bg-gray-800">
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        Kode OTP telah dikirim ke email {{ $currentEmail }}. Masukkan kode 6 digit untuk memverifikasi.
                    </p>
                    ...
                    <form wire:submit="verifyOtp" class="mt-4 space-y-4">
                        ...
                        <div class="flex justify-end gap-3">
                            <x-filament::button color="gray" type="button" wire:click="cancelOtp">
                                Batal
                            </x-filament::button>
                            <x-filament::button type="submit" wire:loading.attr="disabled">
