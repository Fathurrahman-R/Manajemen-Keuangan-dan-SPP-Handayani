{{-- Hero section --}}
<section id="beranda" class="relative overflow-hidden lg:flex lg:min-h-[calc(100vh-4rem)] lg:items-stretch">
    ...
    <div class="relative mx-auto max-w-full lg:w-full lg:grid lg:grid-cols-2 lg:px-16">
        {{-- Text content --}}
        <div class="px-4 py-12 lg:py-16 lg:pr-6 lg:pl-0 z-10 flex flex-col justify-center">
            {{-- H1 --}}
            <h1 class="font-display text-4xl font-bold leading-[1.05] text-foreground md:text-5xl lg:text-6xl  lg:mt-auto">
            ...
            {{-- Stats --}}
            <dl class="mt-12 grid max-w-full grid-cols-3 gap-6 border-t border-border pt-6 lg:mt-auto ">
