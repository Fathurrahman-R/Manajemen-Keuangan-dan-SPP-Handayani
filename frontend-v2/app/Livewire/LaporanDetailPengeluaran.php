...
class LaporanDetailPengeluaran extends Component implements HasActions, HasSchemas, HasTable
{
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                TextColumn::make('nama_pengeluaran')->label('Nama Pengeluaran')->wrap(),
                TextColumn::make('pengaju')->label('Pengaju')->placeholder('-'),
                TextColumn::make('penyetuju')->label('Penyetuju')->placeholder('-'),
            ...
            ->emptyStateDescription('Tidak ada transaksi pengeluaran pada periode ini.')
